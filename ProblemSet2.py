...
def problem2_1():
    ...
    for i in range(0,len(lis)):
        print(lis[i],end=" ") # replace this pass (a do-nothing) statement with your code
...
def problem2_4():
    ...
    for i in range(0,10):
        ...
        lst.append(x)
    print(lst) # replace this pass (a do-nothing) statement with your code
problem2_4()
 # replace this pass (a do-nothing) statement with your code
...
def problem2_5():
    ...
    for roll in range(0,10):
        print(random.randint(1,6)) # replace this pass (a do-nothing) statement with your code
...
def problem2_6():
    ...
    print(x) # don't remove when you submit for grading
     # replace this pass (a do-nothing) statement with your code
...
def problem2_7():
    ...
    print("Area of a triangle with sides",S1,S2,S3,"is",A)# replace this pass (a do-nothing) statement with your code
