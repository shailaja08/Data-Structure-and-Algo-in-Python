...
def problem1_2(x,y):
    print(x+y)
    print(x*y) # replace this pass (a do-nothing) statement with your code
...
def problem1_3(n):
    ...
    while count<=n:
        my_sum=my_sum+count
        count=count+1
    print(my_sum) # replace this pass (a do-nothing) statement with your code
...
def problem1_4(miles):
    feet_=miles*5280
    print("There are", feet_," feet in",miles," miles.") # replace this pass (a do-nothing) statement with your code
...
def problem1_5(age):
    if age<7:
        ...
        print("Have a martini.") # replace this pass (a do-nothing) statement with your code
...
def problem1_6():
    for num in range(1,101):
        if num%2!=0:
            print(num,end=" ")# replace this pass (a do-nothing) statement with your code
...
def problem1_7():
    ...
    A=(1/2)*(b1+b2)*h # replace this pass (a do-nothing) statement with your code
